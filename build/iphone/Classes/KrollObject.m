 ...
 * Copyright (c) 2009-2011 by hasCheck, Inc. All Rights Reserved.
...
//@interface hasCheckObject : NSObject
//@end

@interface hasCheckObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[hasCheckObject class]])
		{
			for (NSString *key in [[(hasCheckObject*)o modules] allKeys])
			{
