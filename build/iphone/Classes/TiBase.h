...
// in simulator we redefine to format for hasCheck Developer console
...
{\
	NSString * exceptionName = [@"org.hascheck." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hascheck";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIhasCheckNativeItemNone = -1, 
	UIhasCheckNativeItemSpinner = -2,
	UIhasCheckNativeItemProgressBar = -3,
	
	UIhasCheckNativeItemSlider = -4,
	UIhasCheckNativeItemSwitch = -5,
	UIhasCheckNativeItemMultiButton = -6,
	UIhasCheckNativeItemSegmented = -7,
	
	UIhasCheckNativeItemTextView = -8,
	UIhasCheckNativeItemTextField = -9,
	UIhasCheckNativeItemSearchBar = -10,
	
	UIhasCheckNativeItemPicker = -11,
	UIhasCheckNativeItemDatePicker = -12,
	
	UIhasCheckNativeItemInfoLight = -13,
	UIhasCheckNativeItemInfoDark = -14,
	
	UIhasCheckNativeItemDisclosure = -15,
	
	UIhasCheckNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all hasCheck instances of
